...
// extensions constants
    ...
    public static final double ZERO_DEGREES = .206;
    public static final double FORTYFIVE_DEGREES = .444;
    public static final double NINETY_DEGREES = .652;
    public static final double ONETHIRTYFIVE_DEGREES = .846;
    public static final double ONEEIGHTY_DEGREES = 1.046;
    public static final double TWOTWENTYFIVE_DEGREES = 1.29;

    // turret min/max  analog potentiometer values
    public static final double TURRET_MIN_POSITION = .1; //1.26
    public static final double TURRET_MAX_POSITION = 1.426;
